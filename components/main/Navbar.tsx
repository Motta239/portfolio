      ...
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[10px]">
        ...
        >
          <Image
            ...
            width={40}
            height={40}
            className="cursor-pointer  object-cover rounded-full hover:animate-slowspin"
          />
          <span className="font-bold ml-[10px] hidden hover:scale-110 shadow-white  md:block text-gray-300">
            Moti Yosef
          </span>
        </a>
